...
public class StringUtils {
	...
	public static String buildTextHeader(String month, String year){
		Calendar cal = Calendar.getInstance();
		StringBuilder textHeader = new StringBuilder(0);
		String monthName = capitalize(StringUtils.getMonth(Integer.parseInt(month)));
		cal.set(Integer.parseInt(year), Integer.parseInt(month) - 1, 1);		
		textHeader.append("01");
		textHeader.append("-").append(monthName).append("-").append(cal.get(Calendar.YEAR));
	    textHeader.append(" al ");
	    textHeader.append(cal.getActualMaximum(Calendar.DAY_OF_MONTH)).append("-").append(monthName).append("-");
	    textHeader.append(year);
