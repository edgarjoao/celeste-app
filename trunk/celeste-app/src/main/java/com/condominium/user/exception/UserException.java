package com.condominium.user.exception;
 ...
 *
 */
public class UserException extends CondominiumException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5490161169986226501L;
