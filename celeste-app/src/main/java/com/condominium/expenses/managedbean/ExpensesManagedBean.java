...
public class ExpensesManagedBean implements Serializable {
	...
	public String searchAction(){
		try{
			expensesList = expensesService.searchExpensesList(Integer.parseInt(expensesSearchMonth), 
								Integer.parseInt(expensesSearchYear), Integer.parseInt(expensesSearchProvier), Integer.parseInt(expensesSearchCategory));
	...
	public String editExpensesAction(){		
		try {
			expensesEditView.setUserId(JSFUtil.getSessionAttribute(UserView.class, "userView").getUserId());
	...
	public String addExpensesAction(){		
		try{
			this.expensesView.setUserId(JSFUtil.getSessionAttribute(UserView.class, "userView").getUserId());
			this.expensesService.addExpenses(expensesView);
			this.clean();
			JSFUtil.writeMessage(FacesMessage.SEVERITY_INFO, "El egreso se ha registrado correctamente.", "El egreso se ha registrado correctamente.");
		} catch (ExpensesException e) {
